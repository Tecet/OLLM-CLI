...
**See Also:**
- [Extension System Overview](README.md) - Extension system introduction
- [Extension Development Guide](development-guide.md) - Creating extensions
...
### Documentation
- [Extension System Overview](README.md) - Introduction
- [Extension Development Guide](development-guide.md) - Creating extensions
- [Manifest Reference](manifest-reference.md) - Manifest schema
- [Marketplace Guide](marketplace.md) - Extension marketplace
...
**Version:** 0.1.0  
**Next:** [Extension Development Guide](development-guide.md)
