/**
 * Utility functions for prompt management and tier resolution
 */
...
// Initialize tiered prompt store
...
/**
 * Convert string mode to OperationalMode enum
 */
...
/**
 * Convert tier to key string for file lookup
 */
...
/**
 * Load tier-specific prompt with fallback to file system
 */
...
/**
 * Strip a specific section from source text
 */
