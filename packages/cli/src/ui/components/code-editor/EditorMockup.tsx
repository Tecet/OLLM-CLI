...
const SAMPLE_CODE = [
  ...
  { line: 9, content: [] },
  { line: 10, content: [
    { text: '// Assets now live adjacent to the component', color: 'gray' },
  ]},
  { line: 11, content: [
    { text: 'const', color: 'magenta' },
  ...
  { line: 22, content: [] },
  { line: 23, content: [
    { text: '// Frame data structure', color: 'gray' },
  ]},
  { line: 24, content: [
    { text: 'interface', color: 'magenta' },
    { text: ' ', color: 'white' },
  ...
  { line: 28, content: [] },
  { line: 29, content: [
    { text: '// Helper: Integer to RGBA', color: 'gray' },
  ]},
  { line: 30, content: [
