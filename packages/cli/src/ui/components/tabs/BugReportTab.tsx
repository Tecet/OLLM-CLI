    ...
    <Box flexDirection="column" height="100%" width={width}>
      ...
      >
        <Box flexDirection="column" width="80%">
          ...
          <Box justifyContent="center" marginBottom={1}>
            <Text color={uiState.theme.text.primary}>Hey there! 👋</Text>
          </Box>
          ...
          <Text color={uiState.theme.text.secondary}>• Clear description of what went wrong</Text>
          <Text color={uiState.theme.text.secondary}>• Steps to reproduce (1, 2, 3...)</Text>
          <Text color={uiState.theme.text.secondary}>• Expected vs actual behavior</Text>
          <Text color={uiState.theme.text.secondary}>• Your OS and OLLM CLI version</Text>
          <Box marginBottom={2}>
            <Text color={uiState.theme.text.secondary}>
          ...
          <Box marginBottom={1}>
            <Text
              ...
              bold={selectedPlatform === 'discord' && hasFocus}
            >
          ...
          <Box marginBottom={1}>
            <Text
              color={uiState.theme.text.accent}
              bold={selectedPlatform === 'github' && hasFocus}
            >
      ...
      {showConfirmation && (
        ...
        >
          ...
          >
            ...
            <Box justifyContent="center" marginBottom={1}>
              <Text color={uiState.theme.text.secondary}>
                This will open {selectedPlatform === 'discord' ? 'Discord' : 'GitHub'} in your
                default browser.
              </Text>
            </Box>
