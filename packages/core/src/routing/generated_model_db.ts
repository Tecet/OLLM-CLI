...
export const GENERATED_MODEL_DB: ModelEntry[] = [
  {
    ...
    profiles: ['4k', '8k', '16k', '32k', '64k', '128k'],
  },
  {
...
export const GENERATED_RAW_PROFILES = {
  'user-unknown-model': {
    ...
    description:
      'Unknown model - please edit your settings at ~/.ollm/LLM_profiles.json (Windows: C:\\Users\\{username}\\.ollm\\LLM_profiles.json)',
    abilities: ['Unknown'],
    tool_support: false,
