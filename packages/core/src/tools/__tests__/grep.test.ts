...
describe('GrepTool', () => {
  ...
  describe('execute', () => {
    it('should search for pattern in files', async () => {
      ...
      const invocation = tool.createInvocation({ pattern: 'pattern' }, context);
    ...
    it('should handle no matches', async () => {
      ...
      const context = createToolContext(mockMessageBus);
      const invocation = tool.createInvocation({ pattern: 'nonexistent' }, context);
      const result = await invocation.execute(abortSignal);
    ...
    it('should not require confirmation', async () => {
      const context = createToolContext(mockMessageBus);
      const invocation = tool.createInvocation({ pattern: 'test' }, context);
