...
describe('WebSearchTool', () => {
  ...
  describe('createInvocation', () => {
    it('should create invocation with query', () => {
      const invocation = tool.createInvocation({ query: 'test query' }, mockContext);
...
describe('WebSearchInvocation', () => {
  ...
  describe('getDescription', () => {
    it('should return search description', () => {
      const invocation = new WebSearchInvocation({ query: 'test query' }, mockProvider);
  ...
  describe('execute', () => {
    ...
    it('should handle empty query', async () => {
      const invocation = new WebSearchInvocation({ query: '' }, mockProvider);
