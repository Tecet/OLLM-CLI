...
describe('WebFetchTool', () => {
  ...
  describe('execute', () => {
    it('should fetch URL content', async () => {
      ...
      const invocation = tool.createInvocation({ url: 'https://example.com' }, context);
    ...
    it('should handle invalid URL', async () => {
      const context = createToolContext(mockMessageBus);
      const invocation = tool.createInvocation({ url: 'not-a-url' }, context);
      const result = await invocation.execute(abortSignal);
    ...
    it('should reject non-HTTP protocols', async () => {
      const context = createToolContext(mockMessageBus);
      const invocation = tool.createInvocation({ url: 'ftp://example.com' }, context);
      const result = await invocation.execute(abortSignal);
    ...
    it('should handle HTTP errors', async () => {
      ...
      const context = createToolContext(mockMessageBus);
      const invocation = tool.createInvocation({ url: 'https://example.com/missing' }, context);
      const result = await invocation.execute(abortSignal);
