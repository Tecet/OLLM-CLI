 ...
 * ```
 */
export function extractCheckpointSummaries(checkpoints: CompressionCheckpoint[]): Message[] {
 ...
 * ```
 */
export function calculateTotalCheckpointTokens(checkpoints: CompressionCheckpoint[]): number {
 ...
 * ```
 */
export function calculateTotalOriginalTokens(checkpoints: CompressionCheckpoint[]): number {
