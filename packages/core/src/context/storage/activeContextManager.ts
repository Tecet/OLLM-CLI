...
export class ActiveContextManager {
  ...
  constructor(
    ...
    const systemTokens = this.tokenCounter.countTokensCached(systemPrompt.id, systemPrompt.content);
  ...
  addMessage(message: Message): void {
    const messageTokens = this.tokenCounter.countTokensCached(message.id, message.content);
