...
async function demonstrateCompression() {
  ...
  messages.forEach((msg, i) => {
    ...
    console.log(`${i}. [${msg.role.padEnd(9)}] ${tokens.toString().padStart(4)} tokens | ${preview}...`);
  });
  ...
  result.forEach((msg, i) => {
    ...
    console.log(`${i}. [${msg.role.padEnd(9)}] ${tokens.toString().padStart(4)} tokens | ${preview}... ${marker}`);
  });
