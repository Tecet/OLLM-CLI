...
**Key Sections:**
- [What is MCP?](getting-started.md#what-is-mcp)
- [Using MCP Servers](getting-started.md#using-mcp-servers)
- [Using Hooks](getting-started.md#using-hooks)
- [Using Extensions](getting-started.md#using-extensions)
...
**Key Sections:**
- [What are Hooks?](hooks/README.md#what-are-hooks)
- [Hook Events](hooks/README.md#hook-events)
- [Trust Model](hooks/README.md#trust-model)
- [Common Use Cases](hooks/README.md#common-use-cases)
- [Development](hooks/README.md#development)

**Related Documentation:**
- [Hook User Guide](hooks/user-guide.md) ⏳ Coming soon
- [Hook Development Guide](hooks/development-guide.md) ⏳ Coming soon
- [Hook Protocol](hooks/protocol.md) ⏳ Coming soon
...
**Key Sections:**
- [What are Extensions?](extensions/README.md#what-are-extensions)
- [Extension Structure](extensions/README.md#extension-structure)
- [Permissions](extensions/README.md#permissions)
- [Hot-Reload](extensions/README.md#hot-reload)
- [Development](extensions/README.md#development)

**Related Documentation:**
- [Extension User Guide](extensions/user-guide.md) ⏳ Coming soon
- [Extension Development Guide](extensions/development-guide.md) ⏳ Coming soon
- [Manifest Reference](extensions/manifest-reference.md) ⏳ Coming soon
- [Marketplace Guide](extensions/marketplace.md) ⏳ Coming soon

---

## MCP Servers

### [MCP Servers Overview](servers/README.md)
...
**Key Sections:**
- [What are MCP Servers?](servers/README.md#what-are-mcp-servers)
- [Configuration](servers/README.md#configuration)
- [OAuth Authentication](servers/README.md#oauth-authentication)
- [Health Monitoring](servers/README.md#health-monitoring)
- [Available Servers](servers/README.md#available-servers)

**Related Documentation:**
- [Server Development Guide](servers/development-guide.md) ⏳ Coming soon
- [OAuth Setup Guide](servers/oauth-setup.md) ⏳ Coming soon
- [Health Monitoring Guide](servers/health-monitoring.md) ⏳ Coming soon
...
**Key Sections:**
- [MCP Client API](api/README.md#mcp-client-api)
- [Hook System API](api/README.md#hook-system-api)
- [Extension Manager API](api/README.md#extension-manager-api)
- [Common Patterns](api/README.md#common-patterns)
- [Error Handling](api/README.md#error-handling)

**Related Documentation:**
- [MCP Client API Reference](api/mcp-client.md) ⏳ Coming soon
- [Hook System API Reference](api/hook-system.md) ⏳ Coming soon
- [Extension Manager API Reference](api/extension-manager.md) ⏳ Coming soon
...
**Then Explore:**
- [Hooks Overview](hooks/README.md) - Automation
- [Extensions Overview](extensions/README.md) - Extensions
- [Servers Overview](servers/README.md) - MCP servers
...
3. [API Overview](api/README.md) - API reference

**Then Explore:**
- [Hook Development](hooks/README.md#development) - Creating hooks
- [Extension Development](extensions/README.md#development) - Creating extensions
...
**Then Explore:**
- [OAuth Setup](servers/README.md#oauth-authentication) - Authentication
- [Health Monitoring](servers/README.md#health-monitoring) - Monitoring
- [Extension Marketplace](extensions/README.md) - Extension management
...
- [Server Configuration](servers/README.md#configuration) - Server setup
- [OAuth Setup](servers/README.md#oauth-authentication) - Authentication

### Usage & Commands
- [MCP Commands](MCP_commands.md) - All commands
- [Getting Started](getting-started.md) - Basic usage
- [Hooks Overview](hooks/README.md) - Hook usage
- [Extensions Overview](extensions/README.md) - Extension usage

### Development
- [MCP Architecture](MCP_architecture.md) - System design
- [API Overview](api/README.md) - API reference
- [Hook Development](hooks/README.md#development) - Creating hooks
- [Extension Development](extensions/README.md#development) - Creating extensions
- [Server Development](servers/README.md#development) - Creating servers
...
- [Getting Started](getting-started.md#troubleshooting) - Setup issues
- [MCP Integration](MCP_integration.md#troubleshooting) - Integration issues
- [Health Monitoring](servers/README.md#health-monitoring) - Server issues
...
**By Feature:**
- Hooks → [Hooks Overview](hooks/README.md)
- Extensions → [Extensions Overview](extensions/README.md)
- Servers → [Servers Overview](servers/README.md)
