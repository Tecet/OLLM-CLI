...
6. [Using Extensions](#using-extensions)
...
**See:** [Hooks User Guide](hooks/user-guide.md) for more examples
...
**See:** [Extension Development Guide](extensions/development-guide.md)
...
**For Users:**
- [MCP Commands Reference](MCP_commands.md) - All available commands
- [Hooks User Guide](hooks/user-guide.md) - Advanced hook usage
- [Extensions User Guide](extensions/user-guide.md) - Extension management
...
- [Creating MCP Servers](servers/development-guide.md) - Build servers

**For Administrators:**
- [OAuth Setup](servers/oauth-setup.md) - Configure OAuth
- [Health Monitoring](servers/health-monitoring.md) - Monitor servers
- [Extension Marketplace](extensions/marketplace.md) - Manage marketplace
