...
### [Ollama Models Reference](reference/ollama-models.md)
...
### [Model Management Service API](api/model-management-service.md)
...
### [Model Router API](api/model-router.md)
**ModelRouter API**
...
4. [Memory User Guide](memory/user-guide.md) - Using memory
5. [Templates User Guide](templates/user-guide.md) - Using templates

### For Regular Users
1. [Configuration Guide](Models_configuration.md) - Configuration options
2. [Routing User Guide](routing/user-guide.md) - Using routing
3. [Profiles User Guide](profiles/user-guide.md) - Using profiles
4. [Profiles Reference](routing/profiles-reference.md) - Routing profiles
5. [Template Reference](templates/template-reference.md) - Template format

### For Developers
1. [Model Architecture](Models_architecture.md) - System architecture
2. [Routing Development Guide](routing/development-guide.md) - Custom routing
3. [API Reference](api/) - API documentation
4. [Model Management Service API](api/model-management-service.md) - Service API
5. [Model Router API](api/model-router.md) - Router API
...
### Model Lifecycle
- [Getting Started - Basic Model Management](getting-started.md#basic-model-management)
...
- [Getting Started - Configuration](getting-started.md#configuration)
