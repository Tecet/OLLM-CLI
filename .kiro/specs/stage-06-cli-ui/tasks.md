...
- [ ] 1. Set up CLI infrastructure and configuration system
...
- [ ] 1.2 Write property test for configuration validation errors
...
- [ ] 2. Implement GPU monitoring service
  ...
  - [ ] 2.3 Write property test for GPU temperature warning
    - **Property 4: GPU Temperature Warning**
    - **Validates: Requirements 2.3**

  - [ ] 2.4 Write property test for VRAM query structure
    - **Property 5: VRAM Query Structure**
    - **Validates: Requirements 2.4**

  - [ ] 2.5 Write unit tests for GPU monitor
    - Test vendor detection with mocked commands
    - Test query parsing with sample outputs
    - Test fallback behavior
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6_

- [ ] 3. Implement non-interactive runner
  - [ ] 3.1 Create non-interactive runner with output formats
  ...
  - [ ] 3.2 Implement error handling with exit codes
  ...
  - [ ] 3.3 Write property test for non-interactive mode selection
    - **Property 6: Non-Interactive Mode Selection**
    - **Validates: Requirements 3.1, 3.2**

  - [ ] 3.4 Write property test for output format compliance
    - **Property 7: Output Format Compliance**
    - **Validates: Requirements 3.4**

  - [ ] 3.5 Write property test for NDJSON stream format
    - **Property 8: NDJSON Stream Format**
    - **Validates: Requirements 3.5**

  - [ ] 3.6 Write property test for error exit codes
...
- [ ] 5. Implement UI context management
  - [ ] 5.1 Create UIContext for global UI state
  ...
  - [ ] 5.2 Create GPUContext for GPU monitoring state
    - Integrate with GPU monitor service
    - Implement polling and updates
    - Handle loading and error states
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6_

  - [ ] 5.3 Create ChatContext for chat state
  ...
  - [ ] 5.4 Create ReviewContext for diff review state
...
- [ ] 6. Implement theme system
  - [ ] 6.1 Create UI settings with default theme
  ...
  - [ ] 6.3 Create theme manager service
  ...
  - [ ] 6.4 Write property test for theme merging
    - **Property 31: Theme Merging**
    - **Validates: Requirements 18.2**

  - [ ] 6.5 Write property test for theme switching
    - **Property 32: Theme Switching**
    - **Validates: Requirements 18.4**

- [ ] 7. Implement layout components
  - [ ] 7.1 Create TabBar component
  ...
  - [ ] 7.2 Write property test for tab keyboard shortcuts
    - **Property 10: Tab Keyboard Shortcuts**
    - **Validates: Requirements 4.2**

  - [ ] 7.3 Write property test for notification badge display
    - **Property 11: Notification Badge Display**
    - **Validates: Requirements 4.3**

  - [ ] 7.4 Write property test for active tab highlighting
    - **Property 13: Active Tab Highlighting**
    - **Validates: Requirements 4.5**

  - [ ] 7.5 Create SidePanel component
  ...
  - [ ] 7.6 Write property test for side panel toggle
    - **Property 14: Side Panel Toggle**
    - **Validates: Requirements 5.1**

  - [ ] 7.7 Write property test for side panel visibility persistence
    - **Property 15: Side Panel Visibility Persistence**
    - **Validates: Requirements 5.5**

  - [ ] 7.8 Create StatusBar component
  ...
  - [ ] 7.9 Write property test for connection status indicators
    - **Property 16: Connection Status Indicators**
    - **Validates: Requirements 6.1**

  - [ ] 7.10 Write property test for token usage format
    - **Property 17: Token Usage Format**
    - **Validates: Requirements 6.3**

  - [ ] 7.11 Write property test for review count display
    - **Property 18: Review Count Display**
    - **Validates: Requirements 6.6**

  - [ ] 7.12 Create InputBox component
...
- [ ] 10. Implement performance metrics
  ...
  - [ ] 10.3 Create MetricsDisplay component
  ...
  - [ ] 10.4 Write property test for metrics display completeness
    - **Property 25: Metrics Display Completeness**
    - **Validates: Requirements 15.1, 15.2, 15.3, 15.4**

  - [ ] 10.5 Write property test for TTFT conditional display
    - **Property 26: TTFT Conditional Display**
    - **Validates: Requirements 15.5**

  - [ ] 10.6 Write property test for compact metrics format
    - **Property 27: Compact Metrics Format**
    - **Validates: Requirements 15.6**

- [ ] 11. Implement reasoning model support
  - [ ] 11.1 Create ReasoningParser service
  ...
  - [ ] 11.2 Write property test for reasoning block extraction
    - **Property 28: Reasoning Block Extraction**
    - **Validates: Requirements 16.1**

  - [ ] 11.3 Create ReasoningBox component
  ...
  - [ ] 11.4 Write property test for reasoning box toggle
...
- [ ] 13. Implement tab components
  - [ ] 13.1 Create ChatTab component
  ...
  - [ ] 13.2 Create ToolsTab component
  ...
  - [ ] 13.3 Write property test for review list completeness
    - **Property 23: Review List Completeness**
    - **Validates: Requirements 9.1**

  - [ ] 13.4 Write property test for review approval removal
    - **Property 24: Review Approval Removal**
    - **Validates: Requirements 9.3, 9.4**

  - [ ] 13.5 Create FilesTab component
  ...
  - [ ] 13.8 Create SettingsTab component
...
- [ ] 14. Implement launch screen
  - [ ] 14.1 Create LaunchScreen component
  ...
  - [ ] 14.2 Implement /home command
    - Add command to return to launch screen
    - _Requirements: 14.6_

- [ ] 15. Implement session management commands
  - [ ] 15.1 Create session command handlers
...
- [ ] 16. Implement slash command system
  ...
  - [ ] 16.3 Implement provider commands
    - /provider list
    - /provider use
    - _Requirements: 19.3_

  - [ ] 16.4 Implement git commands
    - /git status
    - /git commit
    - /git undo
    - _Requirements: 19.5_

  - [ ] 16.5 Implement review commands
    - /review enable
    - /review disable
    - /review pending
    - _Requirements: 19.6_

  - [ ] 16.6 Implement extension commands
    - /extensions list
    - /extensions enable
    - /extensions disable
    - _Requirements: 19.7_

  - [ ] 16.7 Implement theme commands
    - /theme list
    - /theme use
    - /theme preview
    - _Requirements: 19.8_

  - [ ] 16.8 Implement context commands
    - /context
  ...
  - [ ] 16.9 Implement metrics commands
    - /metrics
    - /metrics toggle
    - /metrics reset
    - _Requirements: 19.10_

  - [ ] 16.10 Implement reasoning commands
    - /reasoning toggle
    - /reasoning expand
    - /reasoning collapse
    - _Requirements: 19.11_

  - [ ] 16.11 Implement utility commands
    - /help
    - /exit
    - /home (already implemented in 14.2)
    - _Requirements: 19.12_

  - [ ] 16.12 Write property test for command suggestions
    - **Property 33: Command Suggestions**
    - **Validates: Requirements 22.2**

  - [ ] 16.13 Write property test for missing argument help
...
- [ ] 18. Implement keyboard shortcuts
  - [ ] 18.1 Create keyboard input handler
  ...
  - [ ] 18.2 Wire up all keyboard shortcuts
...
- [ ] 19. Implement error handling
  - [ ] 19.1 Add configuration error handling
  ...
  - [ ] 19.4 Write property test for connection error display
    - **Property 35: Connection Error Display**
    - **Validates: Requirements 22.4**

  - [ ] 19.5 Add UI error handling
...
- [ ] 20. Integration and wiring
  ...
  - [ ] 20.2 Integrate GPU monitoring with status bar
  ...
  - [ ] 20.3 Integrate metrics collection with chat
