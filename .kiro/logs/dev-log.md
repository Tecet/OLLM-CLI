...
_Tool System (packages/core/src/tools):_
...
_Policy System (packages/core/src/policy):_
...
_ChatCompressionService (387 lines):_
...
_LoopDetectionService (236 lines):_
...
_EnvironmentSanitizationService (135 lines):_
...
_FileDiscoveryService (262 lines):_
...
_ShellExecutionService (173 lines):_
...
_Error Sanitization (142 lines):_
...
_Service Configuration (157 lines):_
...
- GitHub token detection (ghp\_\* pattern)
- Nested object sanitization
...
- Wildcard patterns: _\_KEY, _\_SECRET, \*\_TOKEN
- Prefix patterns: AWS*\*, GITHUB*\*
...
_VRAM Monitor (packages/core/src/context/vramMonitor.ts - 289 lines):_
...
_GPU Detector (packages/core/src/context/gpuDetector.ts - 156 lines):_

- Platform-specific GPU detection
- Command-line tool availability checking
- GPU type enumeration (NVIDIA, AMD, APPLE_SILICON, CPU_ONLY)

_Token Counter (packages/core/src/context/tokenCounter.ts - 187 lines):_
...
_Context Pool (packages/core/src/context/contextPool.ts - 195 lines):_
...
_Snapshot Storage (packages/core/src/context/snapshotStorage.ts - 445 lines):_
...
_Snapshot Manager (packages/core/src/context/snapshotManager.ts - 234 lines):_
...
_Compression Service (packages/core/src/context/compressionService.ts - 515 lines):_
...
_Memory Guard (packages/core/src/context/memoryGuard.ts - 267 lines):_
...
_Context Manager (packages/core/src/context/contextManager.ts - 485 lines):_
...
_Context Command (packages/core/src/commands/contextCommand.ts - 534 lines):_
...
_Context Status UI (packages/cli/src/components/ContextStatus.tsx - 150 lines):_
...
_Types (packages/core/src/context/types.ts - 688 lines):_
...
| Folders created              | 3 (**tests** in hooks, extensions, mcp) |
| Test-to-code ratio           | 2.07:1                                  |
| Test pass rate               | 100%                                    |

**Implementation Breakdown by System:**

_Hooks System (packages/core/src/hooks - 1,834 lines):_
...
_Extensions System (packages/core/src/extensions - 1,637 lines):_
...
_MCP System (packages/core/src/mcp - 1,733 lines):_
...
_Configuration System (packages/cli/src/config):_
...
_Chat Components (packages/cli/src/ui/components/chat):_
...
_Launch Screen (packages/cli/src/ui/components/launch):_

- `LaunchScreen.tsx` - Branded startup screen
- `LlamaAnimation.tsx` - ASCII art animation

_Commands (packages/cli/src/commands):_
...
_Keyboard Shortcuts (packages/cli/src/ui/services):_

- `keyboardHandler.ts` - Shortcut registry and execution

_Main App (packages/cli/src/ui):_
...
_Property-Based Tests (35 properties):_
...
_Integration Tests (12 suites):_
...
**Tool Schema (Properties 8-13):** 8. Valid Tool Schema Acceptance 9. Invalid Tool Schema Rejection 10. Parameter Type Conversion Preservation 11. Tool Result Formatting Consistency 12. Boolean parameter conversion 13. Required field validation

**ReAct Parser (Properties 14-19):** 14. ReAct Format Parsing Completeness 15. JSON Tool Call Extraction 16. Malformed JSON handling 17. Incomplete ReAct format handling 18. Missing action section handling 19. Invalid tool name handling

**Token Estimation (Properties 20-21):** 20. Token Estimation Accuracy 21. Context Limit Enforcement

**Model Routing (Properties 22-24):** 22. Profile-Based Model Selection 23. Fallback Profile Usage 24. Capability-Based Filtering

**Integration (Properties 25-27):** 25. Integration Test Cleanup 26. Streaming Chunk Concatenation 27. Tool Call Streaming Delivery

**Tool Invocation (Properties 28-31):** 28. Tool Invocation Parameter Correctness 29. Tool Result Return 30. Sequential Tool Call Execution 31. Tool Error Message Formatting

**Model Management (Properties 32-34):** 32. Model Metadata Completeness 33. Model Download Progress Events 34. Model List Update After Deletion

**Test Infrastructure (Property 35):** 35. Test State Isolation
...
- Exclusions: node_modules, dist, **tests**, \*.test.ts
